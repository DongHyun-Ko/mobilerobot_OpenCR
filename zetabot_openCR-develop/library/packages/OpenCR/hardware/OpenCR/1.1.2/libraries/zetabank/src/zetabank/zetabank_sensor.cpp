...
#include "../../include/zetabank/zetabank_sensor.h"

ZetabankSensor::ZetabankSensor()
{
}
...
void ZetabankSensor::initIMU(void)
{
  imu_.begin();
}

void ZetabankSensor::updateIMU(void)
{
  imu_.update();
}

void ZetabankSensor::calibrationGyro()
{
  uint32_t pre_time;
  uint32_t t_time;
...
sensor_msgs::Imu ZetabankSensor::getIMU(void)
{
...
float* ZetabankSensor::getOrientation(void)
{
...
sensor_msgs::MagneticField ZetabankSensor::getMag(void)
{
...
float ZetabankSensor::checkVoltage(void)
{
  float vol_value;
...
uint8_t ZetabankSensor::checkPushButton(void)
{
