...
#include "../../include/zetabank/zetabank_diagnosis.h"

ZetabankDiagnosis::ZetabankDiagnosis()
{
}
...
bool ZetabankDiagnosis::init(void)
{
}

void ZetabankDiagnosis::showLedStatus(bool isConnected)
{
...
void ZetabankDiagnosis::updateRxTxLed(void)
{
...
void ZetabankDiagnosis::setPowerOn(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, HIGH);
}

void ZetabankDiagnosis::setPowerOff(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, LOW);
}

uint8_t ZetabankDiagnosis::updateVoltageCheck(bool check_setup)
{  
...
uint8_t ZetabankDiagnosis::getButtonPress(void)
{
