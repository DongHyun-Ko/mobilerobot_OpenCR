...
#ifndef ZETABANK_CORE_CONFIG_H_
#define ZETABANK_CORE_CONFIG_H_
...
#define INIT_LOG_DATA "This core(v1.1.2) is compatible with Zetabank"
...
std_msgs::String error_msg2;
ros::Publisher error_pub2("error2", &error_msg2);
std_msgs::Float64 error_msg3;
ros::Publisher error_pub3("error3", &error_msg3);
...
ros::Publisher left_pub_motor_pos("left_motor_pos", &left_motor_pos_msg);
ros::Publisher right_pub_motor_pos("right_motor_pos", &right_motor_pos_msg);
