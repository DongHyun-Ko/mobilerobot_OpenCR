...
#include "../../include/zetabank/zetabank_controller.h"

ZetabankController::ZetabankController()
{
...
bool ZetabankController::init(float max_lin_vel, float max_ang_vel, uint8_t scale_lin_vel, uint8_t scale_ang_vel)
{
...
void ZetabankController::getRCdata(float *get_cmd_vel)
{
